...
def find_contours(word_label, w):
...
def get_pivot_points(cp, num_cp, tot_seg, seg_w):
    ...
    return cp_section, pp, seg_height


def calc_gradiant(cp_section, pp, half_char_h):
    new_pp = []
...
def make_final_polygon(new_pp, minv, spp, epp):
    poly = []
...
def get_poly_core(boxes, labels, mapper, linkmap):
    ...
    for k, box in enumerate(boxes):
        ...
        """ Polygon generation """
        cp, max_len = find_contours(word_label, w)
        ...
        cp_section, pp, seg_height = get_pivot_points(cp, num_cp, tot_seg, seg_w)
        ...
        new_pp = calc_gradiant(cp_section, pp, half_char_h)
        ...
        # make final polygon
        poly = make_final_polygon(new_pp, minv, spp, epp)
